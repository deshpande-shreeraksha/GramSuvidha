  ...
  const citizenActions = [
    {
      ...
      desc: 'Report water supply leaks, broken streetlights, or road potholes with photo uploads and automatic GPS lock.',
      icon: <ClipboardPlus className="text-[#C4F8FF]" size={20} />,
      path: '/citizen/complaint'
    },
    {
      title: 'Government Scheme\'s',
      desc: 'Explore, check eligibility, and apply for national welfare programs (PMAY, MGNREGA) with digital receipts.',
      icon: <FileText className="text-[#C4F8FF]" size={20} />,
      path: '/citizen/schemes'
    },
    {
      title: 'Panchayat Budget',
      desc: 'Inspect annual development budgets, funds reserves, and itemized sector allocations visually.',
      icon: <DollarSign className="text-[#C4F8FF]" size={20} />,
      path: '/citizen/budget'
    },
    {
      title: 'Property Taxes',
      desc: 'Calculate annual property taxes using official government rules, pay dues online, and download receipts.',
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#0F4B70]/30 backdrop-blur-md text-white p-8 md:p-10 shadow-xl border border-[#C4F8FF]/20">
        <div className="relative z-10 space-y-3 max-w-3xl">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
            Welcome to GramSuvidha Digital Panchayat
          </h1>
          <p className="text-xs md:text-sm text-[#C4F8FF]/70 leading-relaxed">
            Hello, <strong className="text-white font-bold">{citizenName}</strong>. Access Panchayat services, track status of grievances, apply for welfare benefits, and check public council decisions online.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="card bg-[#0F4B70]/20 backdrop-blur-sm p-6 rounded-2xl border border-[#C4F8FF]/15 shadow-sm space-y-6">
            <h3 className="font-extrabold text-lg text-[#C4F8FF] flex items-center gap-2 border-b border-[#C4F8FF]/20 pb-3">
              ...
              Panchayat Digital Notice Board
            </h3>
            ...
            <div className="space-y-4">
              <div className="p-4 border-l-4 border-l-[#C4F8FF] bg-[#0F4B70]/30 rounded-xl space-y-1.5">
                <div className="flex justify-between items-center text-[10px] font-bold text-[#C4F8FF]/60">
                  <span className="uppercase text-[#C4F8FF] font-black">IMPORTANT ANNOUNCEMENT</span>
                  <span>June 2026</span>
                </div>
                <h4 className="font-extrabold text-sm text-[#C4F8FF]">Property Tax Assessment Deadline</h4>
                <p className="text-xs text-[#C4F8FF]/85 leading-relaxed">
                  Citizens are requested to compute and settle their property tax bills for the current assessment cycle. Late filings will attract standard municipal cesses. Pay directly under the "Property Taxes" path in the sidebar.
                </p>
              </div>

              <div className="p-4 border-l-4 border-l-[#C4F8FF] bg-[#0F4B70]/30 rounded-xl space-y-1.5">
                <div className="flex justify-between items-center text-[10px] font-bold text-[#C4F8FF]/60">
                  <span className="uppercase text-[#C4F8FF] font-black">HEALTH DRIVE</span>
                  <span>June 2026</span>
                </div>
                <h4 className="font-extrabold text-sm text-[#C4F8FF]">Universal Vaccination Camp</h4>
                <p className="text-xs text-[#C4F8FF]/85 leading-relaxed">
                  A free village health audit and child immunization camp will be organized at the local Panchayat community building next Monday at 09:00 AM.
                </p>
              </div>
            </div>
                ...
                <div className="p-4 bg-[#0F4B70]/30 border border-[#C4F8FF]/20 rounded-xl space-y-3">
                  <div className="flex justify-between items-center text-xs font-bold text-[#C4F8FF]/70 border-b border-[#C4F8FF]/15 pb-2">
                    <span className="flex items-center gap-1">
                      ...
                      Held: {new Date(latestMeeting.date).toLocaleDateString('en-IN', {day:'2-digit', month:'short', year:'numeric'})}
                    </span>
                    <span className="flex items-center gap-1">
                      <Clock size={14} /> Time: {latestMeeting.time}
                    </span>
                  </div>

                  <div className="text-xs space-y-2">
                    <div>
                      <strong className="text-[#C4F8FF] font-extrabold block">Primary Topics Discussed:</strong>
                      <p className="text-[#C4F8FF]/80 leading-relaxed mt-0.5 text-[11px] line-clamp-2">{latestMeeting.detailsDiscussed}</p>
                    </div>
                    <div>
                      <strong className="text-[#C4F8FF] font-extrabold block">Target Civil Infrastructures before next cycle:</strong>
        ...
        <div className="space-y-6">
          <div className="card bg-[#0F4B70]/20 backdrop-blur-sm p-6 rounded-2xl border border-[#C4F8FF]/15 shadow-sm space-y-4">
            <h3 className="font-extrabold text-base text-[#C4F8FF]">Quick Citizen Actions</h3>
            <p className="text-xs text-[#C4F8FF]/70">Instant shortcuts to direct services.</p>
          ...
          <div className="card bg-[#C4F8FF]/10 border border-[#C4F8FF]/20 p-5 rounded-2xl space-y-3">
            ...
            <p className="text-[11px] text-[#C4F8FF]/80 leading-relaxed">
              If you have questions regarding land records, scheme requirements, or tax values, try querying our AI chatbot helper in the bottom-right corner. It supports Hindi translations too!
            </p>
          </div>
        </div>
      </div>
